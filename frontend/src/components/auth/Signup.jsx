      ...
      <div className='flex items-center justify-center max-w-7xl mx-auto'>
        <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
          ...
          <div className='my-2'>
            ...
            <Input type='tel' placeholder='Enter Your Phone Number' name='phoneNumber' value={input.phoneNumber} onChange={changeEventHandler}>
            </Input>
          </div>
          <div className='my-2'>
          ...
          {
            loading ? <Button className='w-full my-4'><Loader2 className='mr-2 animate-spin h-4 w-4' />Please Wait</Button> : <Button type='submit' className='w-full my-4'>Signup</Button>
          }
